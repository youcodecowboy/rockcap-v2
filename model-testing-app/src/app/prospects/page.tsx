        ...
        <div className="mb-6 bg-amber-50 border border-amber-200 rounded-lg p-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-amber-800">
              <span className="font-medium">In Development</span> — Not all features are fully functional. HubSpot sync works, but prospecting workflows are still being built.
            </p>
          </div>
        </div>
