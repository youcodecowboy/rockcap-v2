...
export const fileItem = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // (Knowledge-bank entry + automatic knowledgeItems extraction retired
    // 2026-07-11 — the upload knowledge feed above is the sole automatic
    // knowledge side effect. Deliberate operator writes — the user-note
    // add-to-intelligence toggle below — survive until the write-side
    // migration.)
