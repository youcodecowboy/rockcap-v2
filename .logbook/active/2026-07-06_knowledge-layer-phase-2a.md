...
- 2026-07-07 — 2a.2 COMPLETE (commit d5c1dabc, deployed, backfilled): voyage-finance-2 embeddings + hybrid RRF search live; semantic test passed ('how leveraged' → interest-rate atoms via vector lane, zero keyword overlap). VOYAGE_API_KEY set in Convex env ($5 credit ≈ lifetime supply). Phase 2a fully done.
