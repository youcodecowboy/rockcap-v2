...
| 43 | 4. Comps/4868 Dark Mills 20241217.pdf | Architect Drawing Pack | 1. Modelling Info and Terms Request (canonical per §3.13; client filed the copy in 4. Comps — circumstantial) | third-party-professional (RRA Architects) | design team / filed as scheme evidence | **Misnamed by briefs as valuation** — sketch drawing pack; 15MB; same bytes re-downloaded as #55. *Corrected 2026-07-07: folder column previously contradicted the §3.13 canonical-home rule; trial classifier followed the rule (modelling_info) and the rule wins.* |
...
| 47 | 4. Comps/DarkMills_AccommodationSchedule_RS_AL_JP_V3.0_20260519.xlsx | Accommodation Schedule | 4. Comps | rockcap | internal deal team | *Corrected 2026-07-07: this row previously listed a series-inferred AppendixA V1_3 that does not exist in Drive; the real corpus file missed by the table is this V3.0 accommodation schedule (verified against the Drive mirror + trial import).* |
...
| 55 | 5. Credit/4868_20Dark_20Mills_2020241217.pdf.pdf | Architect Drawing Pack | canonical: 1. Modelling Info and Terms Request (per §3.13) | third-party-professional (RRA Architects) | credit-submission attachment | **Dup-of #43** (re-download; URL-encoded name, .pdf.pdf); extraction garbled (CAD symbol fonts); brief wrongly expected valuation. *Corrected 2026-07-07: canonical folder aligned to §3.13.* |
