...
| `reply.get({replyEventId})` | Single reply with full body + classification + cancelledCadences. Gmail rows ingested since 2026-07-16 also carry `attachments` metadata (filename/mimeType/size/partId/inline). |
